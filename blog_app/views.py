...
def create_blog(request):
    if request.method == 'POST':
        ...
        Blog.objects.create(author=request.user, title=title, content=content, blog_pic=image)
...
def create_comment(request, blog_id):
    ...
    if request.method == 'POST':
        ...
        Comment.objects.create(author=request.user, blog=blog, text=text)
        return redirect('blog_detail', blog_id=blog.id)
    return render(request, 'blog_app/create_comment.html', {'blog': blog})
